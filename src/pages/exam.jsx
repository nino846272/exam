...
function Exam() {
    return (
        <div>
            ...
            <div className="row all body">
                <div className="col-12 bodyg ">
                    <div className="col-10 bodygo">
                        <h1 className='textb'>Welcome to my store</h1>
                        <p className='te'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident nobis similique libero cumque dolores, delectus quas odio cum magnam, corporis vero natus minus maxime? Consequatur aspernatur sunt exercitationem illum ea.</p>
                    </div>
                </div>
            </div>
            <div className="row all">
